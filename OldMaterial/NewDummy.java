...
//
//        Explanation: To find the sum of the elements in the groups and that sum should be divisible
//        by input X and the groups should be limited to range with X numbers.
